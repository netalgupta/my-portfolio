    ...
    <section id="projects" style={{ padding: '7rem 4rem', background: 'var(--cream)' }}>
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          #projects .project-card-row { width: 100%; overflow: hidden; }
      ...
      <ProjectCard
        ...
        bullets={[
          'AI-Powered Alzheimer\'s Companion Platform: voice-first multilingual AI companion (EN/HI/MR) with LLM-based context grounding',
          'QR-based emergency system with live GPS and real-time caregiver alerts',
          'Tri-role architecture: Patient · Caretaker · Guardian',
          '~4–5s AI response latency on constrained deployment',
        ]}
      ...
      <ProjectCard
        ...
        stack={['Firebase', 'Google Auth', 'Gemini API', 'Full-Stack Web']}
        bullets={[
          'AI evaluation system that generates structured feedback on logic, edge cases, and best practices — not just pass/fail',
          'Interactive AI chatbot for follow-up questions on submitted solutions',
          'Real-time leaderboard with Google Auth for onboarding and persistent sessions',
        ]}
