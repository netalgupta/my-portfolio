  ...
  return (
    <section id="hackathons" style={{ padding: '7rem 4rem', background: '#E8341A', color: '#fff', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="reveal" style={{ marginTop: '4rem', textAlign: 'center' }}>
        <p style={{ fontSize: 'clamp(4rem, 10vw, 8rem)', fontFamily: "'Playfair Display', serif", fontWeight: 900, color: 'rgba(255,255,255,0.12)', lineHeight: 1 }}>
          250+ TEAMS
        </p>
        <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '1rem', fontWeight: 600, marginTop: '-1.5rem' }}>defeated across all hackathons</p>
      </div>
    </section>
  )
}
